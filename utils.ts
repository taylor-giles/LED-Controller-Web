...
export function linearlyInterpolate(color1: {r: number, g: number, b: number}, color2: {r: number, g: number, b: number}, position: number ){
    return {
        r: color1.r + position * (color2.r - color1.r),
        g: color1.g + position * (color2.g - color1.g), 
        b: color1.b + position * (color2.b - color1.b)
    }
}